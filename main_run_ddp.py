...
def get_args_parser():
    ...
    parser.add_argument("--mimic_path", default="/home/wonjun/data/mimic-cxr-jpg-resized512")
...
def train_dino(args):
    ...
    l_dataset = CXR_dataset_Q.MIMIC_Multilabel_Dataset(
        data_path=args.data_folds_path,
    ...
    student = utils.MultiCropWrapper(
        ...
        cls_head=CLSHead(inter_dim, 256, len(args.lesions)),
        args=args
    )
