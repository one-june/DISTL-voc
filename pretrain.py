...
def get_args_parser():
    ...
    parser.add_argument("--voc_path", default="/home/wonjun/data/voc2012/VOCdevkit/VOC2012")
    parser.add_argument("--lesion", default="Pleural Effusion")
    ...
    parser.add_argument("--pretrained_dir", type=str, default='pretrained_weights/pretrain.ckpt',
...
def train_dino(args):
    ...
    if args.arch in vit_o.__dict__.keys():
        ...
        if os.path.isfile(args.pretrained_dir):
            ...
            print("\nTeacher and student loaded without pretrained weights\n")
...
def train_one_epoch(student, teacher, dino_loss, bce_loss, data_loader,
    ...
    for it, (images, labels) in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            loss = bce_loss(torch.hstack(student_cls), labels)
        ...
        # Save attention maps
        # if it % args.save_attn_map_freq == 0:
        #     print(f"Saving attention maps at iter {it}")
