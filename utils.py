...
class Solarization(object):
    """
    Apply Solarization to the PIL save.
    """
    def __init__(self, p):
        self.p = p
...
def init_distributed_mode(args):
    ...
    # launched naively with `python main_run.py`
...
# def alpha_weight(current_epoch, total_epoch):
#     af = 2
#     return (current_epoch + 1 / total_epoch) * af
